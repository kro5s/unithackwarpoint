...
const Card = () => {
    return (
        <article className="p-6 rounded bg-dark-secondary relative z-10 shadow">
            <img src="https://placehold.co/600x400" alt="" className="object-cover aspect-video rounded"/>
            <div className="pt-6 pb-4"><span className="font-bold text-xl">Lorem ipsum</span></div>
            <p className="line-clamp-3 text-sm">
                Lorem ipsum dolor sit amet consectetur. Quis ultricies a venenatis convallis Quis ultricies a venenatis convallis
            </p>
