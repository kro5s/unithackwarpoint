...
const Account = () => {
    ...
    return (
        <div ref={dropdownParent} className="relative cursor-pointer" onClick={handleDropdown}>
            ...
            {
                dropdownOpened &&
                <ul className="absolute top-12 right-0 rounded bg-white text-dark-bg">
                    <li>
                        <Link to="/accountSettings"
                              className="flex items-center gap-x-4 hover:bg-dark-secondary/[0.2] p-4">
                            ...
                            <span className="font-semibold whitespace-pre">Управление аккаунтом</span>
                        </Link>
                    </li>
                    <li>
                        <Link to="/ordersHistory"
                            ...
                            <span className="font-semibold whitespace-pre">История заказов</span>
                        </Link>
                    </li>
                </ul>
            }
